...
<body>
     ...
     <br /><br /><br />
     <div class="container">
          <h3 align="center">Search the Articles </h3>
          <br/>
          <center>
               <div class="container">
                    <div class="container">
			...
			$req_by1=$row1['Display_name'];
						...
						?>
                              <tr>
                                   ...
                                   <td>
                                        <?php echo $row['Bibliographic_details']; ?>
                                   </td>
                                   <td>
				...
				$sta=$row['Status'];
					...
					if($sta=='Pending'){
					?>
                                   <td><img src="image/red-dot.png" width="15px" height="15px" alt="pending"
                                             title="pending" /><span class='hidden'>Pending</span></td>
                                   <?php } ?>
                                   <?php 
					if($sta=='Approached'){
					?>
                                   <td><img src="image/yellow-dot.png" width="15px" height="15px" /><span
                                             class='hidden'>Approached</span></td>
                                   <?php } ?>
                                   <?php
					if($sta=='Complete'){
					?>
                                   <td><img src="image/green-dot.png" width="15px" height="15px" /><span
                                             class='hidden'>Complete</span></td>
                                   <?php } ?>
                                   <?php 
					if($sta=='Received'){
					?>
					...
					if($sta=='Closed'){
					?>
                                   <td><img src="image/blue-dot.png" width="15px" height="15px" /><span
                                             class='hidden'>Closed</span></td>
                                   <?php } ?>
								  ...
								  if($_SESSION['type']=='0' || $_SESSION['type']=='1' ){
									  ?>
                                             <a href="edit_final.php?edit_record=<?php echo $row[" Sr_no"]; ?>"
                                                  class="btn btn-info btn-xs">Edit</a><br />

                                             <input type="button" name="view" value="view" id="<?php echo $row["
                                                  Sr_no"]; ?>" class="btn btn-success btn-xs view_data" /><br />
                                             <input type="button" name="delete" value="delete" id="<?php echo $row["
                                                  Sr_no"]; ?>" class="btn btn-danger btn-xs delete_data" />
                                             <?php 
								  }
								  else{
								?>
                                             <input type="button" name="view" value="view" id="<?php echo $row["
                                                  Sr_no"]; ?>" class="btn btn-info btn-xs view_data" />
                                             <?php } ?>
                                   </td>
                                   <center>
                                        <td>
          ...
          <div class="modal-content">
               ...
               <div class="modal-body">
                    <form method="post" id="insert_form">
                         ...
                         <input type="text" class="form-control" id="req_date" name="req_date"
                              placeholder="Request Date(YYYY/MM/DD)" required>


                         <label for="inputPassword">Request By</label>

                         <input type="text" class="form-control" id="req_by" name="req_by" placeholder="Request By"
                              required>
                         ...
                         <select name="category" id="category" class="form-control">
                              ...
                              <option value="Institute Members">Institute Members</option>
                         </select>
                         ...
                         <table id="dynamic">
                              <tr>
                                   <td width="98%">
                                        <textarea placeholder="Bibliographic details" class="form-control"
                                             id="biblio_det" name="name[]"></textarea>
                                        ...
                                        <input type="text" name="journal_name[]" id="country" class="form-control "
                                             autocomplete="off" placeholder="Journal Name" />
                                   </td>

                                   <td width="2%">
                                        <button type="button" name="add" id="add_input"
                         ...
                         <script>
                              $(document).ready(function () {
                                   ...
                                   $('#add_input').click(function () {
                                        i++;
                                        $('#dynamic').append('<tr id="row' + i + '"><td width="98%"><textarea  class="form-control" name="name[]" placeholder="Bibliographic Details"></textarea><select name="document_type[]" id="document_type" class="form-control"><option value="Journal Article">Journal Article</option>  <option value="Conference Paper">Conference Paper</option> <option value="Standard">Standard</option> <option value="Patent">Patent</option> <option value="Others">Others</option>   </select> <input type="text" class="form-control" id="journal_name" name="journal_name[]" placeholder="Journal name"></td><td width="2%"><button type="button" name="remove" id="' + i + '" class="btn btn-primary btn-xs btn_remove"><i class="fa fa-minus-circle" aria-hidden="true"></i></button></td> </tr>');
                                   });
