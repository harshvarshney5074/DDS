...
if (isset($_POST['update'])) {
    ...
    $update_record = mysqli_query($conn, "UPDATE journal_list SET Journal_name='$jour_name1', Print_ISSN='$print_issn', E_ISSN='$e_issn', Pub_name='$pub_name', Main_pub='$main_pub', Pub_country='$pub_country' WHERE S_no='$get_id'");
...
<div class="container">
    ...
    <form method="post" name="inst_form">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="print_issn" value="<?php echo $print_issn; ?>" class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pub_name" value="<?php echo $pub_name; ?>" class="form-control">
        </div>
        <div class="mb-3">
            <label class="form-label">Main Publication</label>
            <input type="text" name="main_pub" value="<?php echo $main_pub; ?>" class="form-control">
        </div>
        <div class="mb-3">
