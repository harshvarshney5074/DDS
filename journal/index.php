...
<div class="container mt-5 pt-5">
  <h1 class="text-center">Master List of Journals</h1>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="" id="insert_form">
          ...
          <div class="mb-3">
            <label class="form-label">Print-ISSN</label>
            <input type="text" class="form-control" name="print_issn">
          </div>
          <div class="mb-3">
            <label class="form-label">E-ISSN</label>
            <input type="text" class="form-control" name="e_issn">
          </div>
          <div class="mb-3">
            <label class="form-label">Publication Name*</label>
            <input type="text" class="form-control" name="pub_name" required>
          </div>
          <div class="mb-3">
            <label class="form-label">Main Publication</label>
            <input type="text" class="form-control" name="main_pub">
          </div>
          <div class="mb-3">
            <label class="form-label">Publication Country</label>
            <input type="text" class="form-control" name="pub_country">
          </div>
...
if (isset($_POST['insert'])) {
  ...
  $query = mysqli_query($conn, "INSERT INTO journal_list (Journal_name, Print_ISSN, E_ISSN, Pub_name, Main_pub, Pub_country) VALUES ('$jour','$print','$eissn','$pub_name','$main_pub','$pub_country')");
}
?>
